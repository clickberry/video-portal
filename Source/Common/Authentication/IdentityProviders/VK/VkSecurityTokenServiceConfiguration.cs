...
{
    public class VkSecurityTokenServiceConfiguration : SecurityTokenServiceConfiguration, IMetadataProvider
    {
        ...
        public string GetFederationMetadata(Uri endpoint)
        {
            ...
            // metadata document 
            var entity = new EntityDescriptor(new EntityId(VkClaims.IssuerName));
            ...
            sts.ClaimTypesOffered.Add(new DisplayClaim(VkClaims.VkToken, "Token", "Service token"));
